...
def attack(char_name, char_class: str) -> str:
...
def defence(char_name, char_class: str) -> str:
    if char_class == 'warrior':
...
def special(char_name, char_class: str) -> str:
    if char_class == 'warrior':
...
def start_training(char_name, char_class: str) -> str:
    if char_class == 'warrior':
